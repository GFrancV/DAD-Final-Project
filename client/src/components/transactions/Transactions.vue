            ...
            <tr v-for="transaction in transactions" :key="transaction.id">
              ...
              <td v-if="transaction.type == 'C'">
                <p style="display: inline; font-weight: 700; color: green">
                  ...
                  ${{
                    (transaction.new_balance - transaction.old_balance).toFixed(2)
                  }}
                </p>
              </td>
              <td v-else>
                ...
                >
                  ...
                  ${{
                    (transaction.old_balance - transaction.new_balance).toFixed(2)
                  }}
                </p>
              </td>
...
export default {
  ...
  methods: {
    getTransactions() {
      this.$axios
        .get(
          "vcards/" + this.idVcard + "/transactions?page=" + this.currentPage
        )
        .then((response) => {
